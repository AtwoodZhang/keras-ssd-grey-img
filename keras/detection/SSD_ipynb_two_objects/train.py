...
if __name__ == "__main__":
    ...
    save_dir = "/home/zhangyouan/桌面/zya/NN_net/network/SSD/IMX_681_ssd_mobilenet_git/keras/detection/SSD_ipynb_two_objects/output/20231206/"
    ...
    model.save(os.path.join(save_dir, "20231213_good_detection_test_callback.h5"))
    model.save(os.path.join(save_dir, "20231213_good_detection_test_callback.pb"))