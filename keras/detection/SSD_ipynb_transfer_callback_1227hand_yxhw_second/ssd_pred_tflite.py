...
class SSD(object):
    _defaults = {
        "model_path": "/home/zhangyouan/桌面/zya/NN_net/network/SSD/IMX_681_ssd_mobilenet_git/keras/detection/SSD_ipynb_transfer_callback_1227hand_yxhw_second/20231227.h5", 
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        # output_data = 0.11721456050872803 * (output_data + 7)
        #-----------------------------------------------------------#
        #   将预测结果进行解码
        #-----------------------------------------------------------#
