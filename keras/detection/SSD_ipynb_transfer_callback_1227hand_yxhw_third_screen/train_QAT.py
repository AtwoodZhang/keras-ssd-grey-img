...
# 模型路径和图片路径
h5_model_path = "/home/zhangyouan/桌面/zya/NN_net/network/SSD/IMX_681_ssd_mobilenet_git/keras/detection/SSD_ipynb_transfer_callback_1227hand_yxhw_third_screen/output/pc_screen_2/20240810_pc_screen_3_another_init.h5"
...
# 训练QAT模型
q_aware_model.fit_generator(generator=train_dataloader, 
...
# 保存为TFLite文件
output_file = '20240810_pc_screen_5_another_init_qat.tflite'
