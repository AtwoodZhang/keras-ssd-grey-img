...
if __name__ == "__main__":
    ...
    save_dir = "/home/zhangyouan/桌面/zya/NN_net/network/SSD/IMX_681_ssd_mobilenet_git/keras/detection/SSD_ipynb_transfer_callback_1227_exchange_yxhw/output/240806"
    ...
    K.clear_session()
    model_path = ""
    model_path = "/home/zhangyouan/桌面/zya/NN_net/network/SSD/IMX_681_ssd_mobilenet_git/keras/detection/SSD_ipynb_transfer_callback_1227_exchange_yxhw/output/240806/20240807_1_command.h5"
    ...
    model.save(os.path.join(save_dir, "20240807_2_command.h5"))
    model.save(os.path.join(save_dir, "20240807_2_command.pb"))