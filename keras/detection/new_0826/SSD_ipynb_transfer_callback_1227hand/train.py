...
if __name__ == "__main__":
    ...
    # model.compile(optimizer=optimizer, loss = [MultiboxLoss(num_cls, neg_pos_ratio=3.0).compute_det_loss, MultiboxLoss(num_cls, neg_pos_ratio=3.0).compute_cls_loss], loss_weights=[1.0, 1.0])
    ...
    model.save(os.path.join(save_dir, "20240823_2.h5"))
    model.save(os.path.join(save_dir, "20240823_2.pb"))