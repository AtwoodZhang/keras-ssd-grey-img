...
if __name__ == "__main__":
    ...
    save_dir = "/home/zhangyouan/桌面/zya/NN_net/network/SSD/IMX_681_ssd_mobilenet_git/keras/detection/SSD_ipynb_two_objects/output/20231205/"
    
    # 设置SSD参数
    cls_name_path = r"/home/zhangyouan/桌面/zya/NN_net/network/SSD/IMX_681_ssd_mobilenet_git/keras/detection/SSD_ipynb_transfer_callback_0919_cola/model_data/voc_classes.txt"  # 导入目标检测类别；
    ...
    model.save(os.path.join(save_dir, "20231213_cola_detection_test_callback.h5"))
    model.save(os.path.join(save_dir, "20231213_cola_detection_test_callback.pb"))