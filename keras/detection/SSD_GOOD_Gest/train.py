...
if __name__ == "__main__":
    ...
    # model_path = '/home/zhangyouan/桌面/zya/NN_net/network/SSD/test2_ssd_test_rewrite/20230226_test1_detection_dog.h5'
    model_path = ''
    # ------------------------------------------------------#
    ...
    if True:
        ...
        if ngpus_per_node > 1:
            checkpoint = ParallelModelCheckpoint(model_body, os.path.join(save_dir,
        ...
        model.save("20230804_orig_test.h5")
        model.save("20230804_orig_test.pb")
